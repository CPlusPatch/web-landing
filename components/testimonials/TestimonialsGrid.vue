            ...
            <div
                ...
                <figure
                    ...
                    <figcaption class="flex items-center gap-x-4 border-t border-gray-900/10 px-6 py-4">
                        <nuxt-img class="h-10 w-10 flex-none rounded ring-1 ring-dark-500 bg-dark-200" width="40"
                        ...
                        <nuxt-img class="h-10 w-auto flex-none" sizes="sm:2.5rem"
                    ...
                    <div v-for="(column, columnIdx) in columnGroup" :key="columnIdx" :class="[
                        ...
                        <figure v-for="testimonial in column" :key="testimonial.author.name"
                            ...
                            <figcaption class="mt-6 flex items-center gap-x-4">
                                <nuxt-img class="h-10 w-10 rounded-full ring-1 ring-dark-500 bg-dark-900"
