        ...
        <Container>
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">
                    I am a competent, experienced developer with professional
                    skills
                </h2>
            ...
            >
                ...
                >
                    <p
                        class="flex-none text-3xl font-bold tracking-tight text-white"
                    >
                        9 years
                    </p>
                    <div class="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                        ...
                        <p class="mt-2 text-base leading-7 text-gray-400">
                            Development for macOS, Windows, Linux, Android, iOS,
                            and the Web.
                        </p>
                    </div>
                </div>
                ...
                >
                    <p
                        class="flex-none text-3xl font-bold tracking-tight text-primary-foreground"
                    >
                        749,162+
                    </p>
                    <div class="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                        <p
                            class="text-lg font-semibold tracking-tight text-primary-foreground"
                        >
                        ...
                        >
                            ...
                            of TypeScript, totaled across every project I've
