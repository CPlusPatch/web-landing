...
import { AnimatedArrow } from "@/components/decorations/AnimatedArrow";
                ...
                <div className="container pb-24 pt-30 sm:pb-32 lg:flex lg:py-40">
                    <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8 mt-20">
                        ...
                        <p className="mt-6 text-lg leading-8 text-muted-foreground">
                            I make apps, websites, servers and dreams through
                            FOSS and open standards. I am a student in computer
                            science and a programmer by passion, with several
                            years of experience in many kinds of fields
                        </p>
                    ...
                    <div className="px-6 lg:contents">
                        <div className="mx-auto max-w-2xl pb-24 pt-16 sm:pb-32 sm:pt-20 lg:ml-8 lg:mr-0 lg:w-full lg:max-w-lg lg:flex-none lg:pt-32 xl:w-1/2">
                            ...
                            <p className="mt-6 text-xl leading-8 text-muted-foreground">
                                I believe in the power of open source and open
                                standards. Nearly all of my work is licensed
                                under a free license such as the GPLv3, which
                                allows me to work with secure, extensible and
                                reliable software.
                            </p>
                            <div className="mt-10 max-w-xl text-base leading-7 text-muted-foreground lg:max-w-none">
                                <p>
                                    While writing code, I adhere to my own set
                                    of principles, which I apply as part of my
                                    philosophy to achieve excellence. Here are
                                ...
                                <ul className="mt-8 space-y-6 text-muted-foreground">
                                    <li className="flex gap-x-3">
                                        ...
                                        <span>
                                            ...
                                            I use systems such as Docker or Nix
                                            to build and deploy my systems in a
                                            way that is reproducible and
                                            sandboxed.
                                        </span>
                                    </li>
                                    <li className="flex gap-x-3">
                                        ...
                                        <span>
                                            ...
                                            errors whenever I edit code, leading
                                            to less bugs and better-looking
                                            outputs.
                                        </span>
                                    </li>
                                    <li className="flex gap-x-3">
                                        ...
                                        <span>
                                            ...
                                            Apps should be written with scaling
                                            up in mind, and this is true of any
                                            system. Things should be done in a
                                            way that they still make sense later
                                            on.
                                        </span>
                                    </li>
                                </ul>
                                ...
                                <p className="mt-6">
                                    ...
                                    hardening: all my devices are protected with
                                    full-disk encryption, I follow
                                    industry-standard security practices and use
                                    Linux and open systems with a hardened
            ...
            <div className="container pb-24 sm:pb-32">
                <div className="relative isolate overflow-hidden bg-card px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
                    ...
                    <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-muted-foreground">
                        Need more information? Want to have a chat? I'll even
                        mail you a new pair of pants if you need one.
                    </p>
                    ...
                    <svg
                        ...
                        className="absolute left-1/2 top-1/2 -z-10 text-primary h-[64rem] w-[64rem] -translate-x-1/2 [mask-image:radial-gradient(closest-side,white,transparent)]"
                        aria-hidden="true"
                    >
                        <circle
                            cx="512"
