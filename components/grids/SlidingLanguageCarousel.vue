	...
	<div class="py-24 relative overflow-hidden flex flex-col gap-3">
		<div
			...
			<div
				...
				:key="system.id"
				class="flex w-70 shrink-0 col-span-1 divide-x divide-dark-300 ring-dark-300 rounded shadow ring-1 duration-200 hover:scale-[102%] no-bad-scale hover:shadow-2xl hover:ring-2 hover:ring-orange-500">
				<Icon
					:name="system.image"
					:class="[
				...
				<div
					class="flex relative flex-col h-full flex-1 justify-center items-start truncate bg-dark">
					<div
