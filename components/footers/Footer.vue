...
<template>
	<footer class="bg-dark-400 z-1" aria-labelledby="footer-heading">
					...
					<div class="mt-10 md:mt-0">
						...
						<ul class="mt-6 space-y-4">
							<li>
								...
								<p
									class="text-xs leading-6 mt-2 text-gray-400 max-w-48">
									Please hotlink this image instead of
									reuploading it.<br />
									<br />
									Alt text included.
								</p>
		...
		<div
			class="px-4 py-4 text-gray-100 text-sm block bg-linear-to-r from-pink-500 via-red-500 to-yellow-500">
