        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-3xl font-bold tracking-tight text-gray-50 sm:text-4xl">
                    I am a competent, experienced developer with mostly hobby
                    projects
                </h2>
                ...
                <div
                    ...
                    <div class="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                        ...
                        <p class="mt-2 text-base leading-7 text-gray-600">
                            ...
                            1,500 commits per year in 2023.
                        </p>
                    </div>
                </div>
                <div
                    ...
                    <div class="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                        <p class="text-lg font-semibold tracking-tight text-white">
                            I have more than 7 years of experience in
                            programming
                        </p>
                ...
                <div
                    ...
                    <div class="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                        ...
                        <p class="mt-2 text-base leading-7 text-orange-200">
                            Including
                            <strong class="font-semibold">42,579</strong> lines
                            of TypeScript, totaled across every project in my
                            Development folder.
                        </p>
                    </div>
                </div>
