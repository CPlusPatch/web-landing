...
export const Navbar: React.FC = () => {
    return (
        <div className="fixed top-0 inset-x-0 flex items-center justify-center h-24 z-10 px-4 py-2 backdrop-filter backdrop-blur-lg bg-opacity-30 border-b border-border/30">
