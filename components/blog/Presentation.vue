    ...
    <div class="px-4 md:px-6 py-24 mx-auto max-w-7xl">
        ...
        <div v-if="posts.length > 0"
            ...
            <article v-for="post in posts" :key="post.frontMatter?.title">
                <NuxtLink class="flex flex-col items-start justify-between" :href="`/blog/${post.path}`">
                    <div class="relative w-full">
                        <nuxt-img format="webp" width="500" :src="post.frontMatter?.image ?? ''" alt=""
                    ...
                    <div class="max-w-xl">
                        <div class="mt-8 flex items-center gap-x-4 text-xs">
                            <time :datetime="post.frontMatter?.created_at ?? '0'" class="text-gray-500">{{
